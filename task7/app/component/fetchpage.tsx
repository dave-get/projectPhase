...
import { useGetOpportunityByIdQuery } from "../service/Datas";
import { JobPost } from "../type/types";

const Fetchpage = ({ id }: { id: string }) => {
  let { data, isLoading } = useGetOpportunityByIdQuery(id);
  const job = data?.data;
  ...
  return (
    <>
      <div className="grid gap-10 p-10 grid-cols-2fr-1fr grid-flow-col min-h-svh">
