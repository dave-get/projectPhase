  ...
  return (
    <>
      <div className="contain bg-slate-100 min-h-svh md:h-fullScreen flex flex-col md:flex-row md:p-16 p-5 gap-5">
        <div className="pageinfo border-slate-300 border h-full md:w-6/12">
          <Image
            src="/welcome.jpg"
            alt=""
        ...
        <div className="bg-slate-200 flex flex-col pt-10 gap-5 md:w-5/12 border-slate-300 border px-5 h-full">
